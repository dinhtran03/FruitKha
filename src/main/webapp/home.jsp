  ...
  <jsp:body>
          ...
          <div class="col-lg-9 offset-lg-2 text-center">
            <div class="hero-text">
              <div class="hero-text-tablecell">
                ...
                <div class="hero-btns">
                  <a href="${pageContext.request.contextPath}/shop" class="boxed-btn">Fruit Collection</a> <a
                    href="${pageContext.request.contextPath}/contact" class="bordered-btn">Contact Us</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          ...
          <div class="content-column col-lg-6">
            ...
            <div class="time-counter">
              <div class="time-countdown clearfix" data-countdown="2025/01/01">
                ...
                <div class="counter-column">
                  <div class="inner">
                    <span class="count" id="mins">00</span>Mins
                  </div>
                </div>
                <div class="counter-column">
                  <div class="inner">
                    <span class="count" id="secs">00</span>Secs
                  </div>
                </div>
              </div>
            </div>
            <a href="${pageContext.request.contextPath}/cart?action=add&quantity=1" class="cart-btn mt-3"><i
            ...
            <div class="testimonial-sliders">
              <div class="single-testimonial-slider">
                ...
                <div class="client-meta">
                  ...
                  <p class="testimonial-body">" Sed ut perspiciatis unde
                    omnis iste natus error veritatis et quasi architecto beatae
                    vitae dict eaque ipsa quae ab illo inventore Sed ut
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12">
            <div class="abt-text">
              ...
              <p>Etiam vulputate ut augue vel sodales. In sollicitudin
                neque et massa porttitor vestibulum ac vel nisi. Vestibulum
    ...
    <section class="shop-banner">
      <div class="container">
        ...
        <a href="${pageContext.request.contextPath}/shop" class="cart-btn btn-lg">Shop Now</a>
      </div>
    </section>
    <!-- end shop banner -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-latest-news">
              ...
              <div class="news-text-box">
                <h3>
                  <a href="single-news.html">You will vainly look for fruit
                    on it in autumn.</a>
                </h3>
                <p class="blog-meta">
